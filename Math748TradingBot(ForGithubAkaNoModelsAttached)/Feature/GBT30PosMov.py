...
class GBT30PosMove:
    ...
    def __init__(self):
        ...
        self.newData = None
        try:
            self.model = load('D:/Python/Math748TradingBot/Feature/SavedModels/GBT30PosMove.joblib')
            ...
            for element in ls:
                ...
                i = i + 1
            self.dct = dct
            self.yy = df.iloc[:, dct['profit30In60TicksClassPlus']].values
    ...
    def getPredSimpleTest1(self, x):
        ...
        if rf_predict_probabilities[0][1]> 0.72:
            print("gbt 30 pos move", rf_predict_probabilities[0][1])
            return [1]
        else:
            return [0]
    ...
    def buildModel(self):
        ...
        try:
            dump(random_search, 'D:/Python/Math748TradingBot/Feature/SavedModels/GBT30PosMove.joblib')
        except:
