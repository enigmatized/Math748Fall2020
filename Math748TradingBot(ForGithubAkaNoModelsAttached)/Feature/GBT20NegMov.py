...
class GBT20NegMove:
    ...
    def __init__(self):
        ...
        self.newData    = None
        try:
            self.model = load('D:/Python/Math748TradingBot/Feature/SavedModels/GBT20NegMove.joblib')
        except:
            ...
            for element in ls:
                ...
                i = i + 1
            self.dct = dct
            self.yy = df.iloc[:, dct['profit20In60TicksClassMinus']].values
    ...
    def buildModel(self):
        ...
        try:
            dump(random_search, 'D:/Python/Math748TradingBot/Feature/SavedModels/GBT20NegMove.joblib')
        except:
